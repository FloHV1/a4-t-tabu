...
public class InventoryManagerTest {
    ...
    void testSearchInventoryByName() {
        ...
        assertEquals(1, results.size(), "Expected to find exactly one product with name 'dmc5'");
    }

    @Test
    void testSearchInventoryBySKU() {
        ArrayList<Product> results = inventory.searchInventory("234");
        assertEquals(1, results.size(), "Expected to find exactly one product with SKU '234'");
    }
